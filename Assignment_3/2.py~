...
u = cv2.imread('StereoImages/Stereo_Pair12.jpg')
...
img_1=cv2.drawKeypoints(left, kp1, left_1)
img_2=cv2.drawKeypoints(left, kp1, left_1)
...
img3 = cv2.drawMatches(img_1,kp1,img_2,kp2,matches,None, flags=2)
